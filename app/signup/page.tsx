...
import { SpinnerIcon } from '@/components/ui/SafeIcon'
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Registration successful! Please check your email to verify your account, then you can login.')
        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Join PrismStudio Internship Program
            </p>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  Already have an account?{' '}
                  <Link href="/login" className="text-blue-600 hover:text-blue-800 font-medium underline-offset-4 hover:underline">
                    Sign in here
                  </Link>
                </p>
              </div>
              ...
              <div className="mt-6 p-3 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-green-800 text-xs text-center">
                  <strong>Production Ready:</strong> Create your account to get started with the internship program
                </p>
              </div>
            </div>
          </div>
